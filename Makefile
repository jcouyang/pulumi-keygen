...
release:
	gh release create v${VERSION} ./ubuntu-latest-binary/pulumi-resource-keygen-v${VERSION}-linux-amd64 ./macos-latest/pulumi-resource-keygen-v${VERSION}-darwin-arm64
